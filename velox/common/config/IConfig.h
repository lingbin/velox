...
/// Read-only config interface for accessing key-value parameters. Supports
/// value retrieval by key and duplication of the raw configuration data. Can be
/// used by velox::QueryConfig to access externally managed system
/// configuration.
class IConfig {
 public:
  template <typename T>
